...
// When joe.scope() is invoked, 'this' refers to the 'joe' instance of the Student object. The function is invoked as a method of the 'joe' instance, so 'this' points to that instance.
// 2. What is "this" when joe.scopeArrow() is invoked?
// When joe.scopeArrow() is invoked, 'this' refers to the global object.
// 3. Explain why "this" is different when an arrow function is used.
// Arrow functions have a different behavior regarding the 'this' context compared to regular functions. In arrow functions, 'this' is lexically scoped, meaning it retains the value of "this" from the surrounding code block. Regular functions, on the other hand, have their own "this" binding, which is determined by how the function is called. Arrow functions are particularly useful in scenarios where you want to preserve the "this" context from the surrounding scope, as seen in the "scopeArrow" function.
